// #region récupérer données photographe
    ...
    async function displayData(photographers) {
        const pagePhotographersSection = document.querySelector(".photograph-header");

        photographers.forEach((photographer) => {
            const photographerModel = pagePhotographerFactory(photographer);
            const userCardDOM = photographerModel.getUserCardDOM();
            pagePhotographersSection.appendChild(userCardDOM);
        });
    };
    ...
    initProfil();
// #endregion récupérer données photographe

// #region récupérer données média
    ...
    async function displayData(medias) {
        const mediaSection = document.querySelector(".pagePhotographer");
    ...
    init();
// #endregion récupérer données média

// #region recupérer données de l'id
    const profilPhotographe = window.location.search.split("?").join("");
    console.log(profilPhotographe);

    let profilData = [];

    const fetchProfil = async () => {
        await fetch(`data/photographers.json/${profilPhotographe}`)
        .then((res) => res.json())
        .then((promise) => {
            console.log(promise);
        });
    ...
    fetchProfil();
// #endregion recupérer données de l'id